...
<a class="odio_editarMisArticulos" href="editar_articulo.php?id=<?=$value["id"]?>">
<img class="photo_editarMisArticulos" src="<?=$plantas[$key]["imagen1"]?>" alt="planta">

    <div class="texto_editarMisArticulos">
      <h3 class="h3_texto_editarMisArticulos"><?=$plantas[$key]["categoria"] ?></h3>

      <h2 class="h2_texto_editarMisArticulos"><?=$plantas[$key]["nombre"] ?></h2>
    </div>
